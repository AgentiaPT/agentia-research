...
|---------|-------------|-----------|------:|-----------|--------|------|
| [Deep Dive: LLMs Corrupt Your Documents When You Delegate (DELEGATE-52)](projects/9980-2026-04-27-delegate52-paper-analysis/) | This paper introduces **DELEGATE-52**, a benchmark that tests whether LLMs can faithfully edit documents across 52 profe... | — | 2.7k | 12 min | Complete | 2026-04-27 |

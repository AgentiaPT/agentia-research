...
|---------|-------------|-----------|------:|-----------|--------|------|
| [AI × Software Engineering — March 14–21, 2026](projects/9985-2026-03-21-ai-news-feed/) | A curated, thematic feed tracking the voices, signals, and narratives shaping the intersection of AI and software engine... | — | 5.7k | 24 min | Draft | 2026-03-21 |

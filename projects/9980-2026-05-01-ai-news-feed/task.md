...
Start the work on latest aixsoftware newsletter update, range April 25 to May 1. The list of stories to cover was to be provided via attachment (not received). Proceeding with independent research + sub-agent fact gathering.

Each story gets an independent sub-agent to get details, confirm everything, gather main facts including source links for easy checking.
...
- Previous "Watch" signals (from §12):
  - The Great AI Coding Price Upheaval — GitHub paused signups, token-based billing coming
  - Anthropic Enterprise Pricing Shift — flat $200 → $20 seat + usage-based
  - Stanford AI Index 2026 — junior dev −20%, SWE-bench near 100%
  - Google 75% AI-Generated Code
  - Tokenmaxxing / Goodhart's Law — 9.4× code churn
  - GitHub Copilot Policy Week — signup pause, training data policy
  - Claude Opus 4.7 on Copilot — 7.5× multiplier
  - OpenAI Workspace Agents — Codex-powered
  - Google Cloud Next '26 — $750M fund, ADK, Agent Studio
  - EU AI Act Article 12 + €63.2M — Aug 2026 deadline
  - Kent Beck "Nobody Wants Agents"
  - Karpathy LLM Wiki
